...
namespace SomerenUI
{
    public partial class DrinkAdd : Form
    {
        ...
        public DrinkAdd(SomerenModel.Drinks drink)
        {
            ...
            this.textBox_DrinkID.Text = drink.drinkName;
            this.textBox_DrinkName.Text = drink.drinkType;
            this.textBox_DrinkType.Text = drink.price.ToString();
            this.textBox_Price.Text = drink.stock.ToString();
            this.textBox_Stock.Text = drink.VAT.ToString();
        }
